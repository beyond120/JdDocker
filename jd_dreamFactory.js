...
async function joinLeaderTuan() {
  ...
  res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/XXXXXXXXXX/jsdelivrCDN@main/shareCodes/jd_updateFactoryTuanId.json');
  // ,...(res2 && res2.tuanIds || [])
  ...
  return new Promise(async resolve => {
    ...
    if (!tuanActiveId) {
      ...
      if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
        ...
        if (!$.tuanConfigs) {
          await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/XXXXXXXXXX/jsdelivrCDN@main/shareCodes/jd_updateFactoryTuanId.json');
          if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
            tuanActiveId = $.tuanConfigs['tuanActiveId'];
            console.log(`拼团活动ID: 获取成功 ${tuanActiveId}\n`)
          } else {
